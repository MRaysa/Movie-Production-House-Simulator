 ...
 * @author abdur
 */
public class ActorsCreatetheMeetingWithDirectorReadWrite {
    public static ArrayList<Meeting>arr;
    public static File fileName;

    public ActorsCreatetheMeetingWithDirectorReadWrite(String Filename) {
        fileName = new File(Filename+"DirectorMeet.bin");
