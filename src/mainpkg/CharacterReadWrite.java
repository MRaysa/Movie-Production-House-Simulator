...
public class CharacterReadWrite {
    ...
    public CharacterReadWrite(String Filename) {
        fileName = new File(Filename+"Character.bin");
        
    }
    
    
    public void writeObj(ArrayList<Character>obj){
    ...
    public  void readObject(){
        ...
        try (ObjectInputStream inputStream = new ObjectInputStream(new FileInputStream(fileName))) {
            ...
            arr = (ArrayList<Character>) inputStream.readObject();
